...
class AndroidGlConformanceTest {
    ...
    /**
     * Cycle E-terrain task 8's gate on Android's driver: does a DEM move the ground by the right number of
     ...
     */
    /**
     * Cycle E-terrain task 11's gate on Android's driver: does terrain shading change a slope's ink, leave
    ...
    /**
     * **Cycle E-terrain task 9's gate on EGL14: ADR 0039's conditional depth write, in pixels.** A
