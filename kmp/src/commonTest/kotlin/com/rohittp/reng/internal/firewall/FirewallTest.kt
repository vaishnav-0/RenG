...
class FirewallTest {
    ...
    fun writesToTheConsumerExactlyOnceWhenTheEngineWritesSelfConsistentBytes() = runTest {
        ...
        // 0.7.0 itself produces -- every raw-store write sits immediately after a transport on the same key.
        fw.transport.execute(engineRequestFor(rasterRoute))
    ...
    fun rejectsAWriteOnARouteWithNoLatchedTransportResponse() = runTest {
        ...
        // so an engine that wrote a route it had never fetched skipped verification entirely. Rentile 0.7.0
